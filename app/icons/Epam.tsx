        ...
        <g id="Layer">
            <g id="Layer">
                <path
                    ...
                    className="s0"
                    fill="#464547"
                    d="m295.6 257.1l0.3 105.3c0 26.8 12.9 40 38.5 40h11.2c25.6 0 38.6-13.2 38.6-40v-51.8h58.9v49.2c0 67.7-32.8 102.2-97.8 102.2h-12.9c-65 0-97.8-34.3-97.8-94.1v-257.5c0-75.7 32.8-109.9 97.8-109.9h12.9c65 0 97.8 34.2 97.8 101.8l-0.3 154.5h-147.2zm86.5-61.2v-95.8c0-26.8-12.6-40.3-38.5-40.3h-9.8c-25.6 0-38.5 13.5-38.5 40.3v95.8z"
                />
                <path
                    id="Layer"
                    fillRule="evenodd"
            ...
            <path
                ...
                className="s1"
                fill="#00abcd"
                d="m156.7 47.1v83.2l-102.4 101.8 102.4 99.8v84.9l-156.5-153.3v-61z"
            />
            <path
                id="Layer"
                className="s1"
                fill="#00abcd"
                d="m1408.5 47.1l156.5 155.4v61l-156.5 153.3v-84.6l102.4-100.1-102.4-101.8z"
            />
        </g>
    </svg>
);
